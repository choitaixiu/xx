...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/src/project.7148a.js';
        if (jsList) {
            jsList = jsList.map(function (x) {
                return 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/src/' + x;
            });
    ...
    cc.AssetLibrary.init({
        libraryPath: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/res/import',
        rawAssetsBase: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/res/raw-',
...
if (false) {
    ...
    if (isRuntime) {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/src/settings.95f5a.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/src/cocos2d-runtime.js');
        require('jsb-adapter/engine/index.js');
    }
    else {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/src/settings.95f5a.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/src/cocos2d-jsb.js');
...
if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/cocos2d-js.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v009/cocos2d-js-min.3a02f.js';
