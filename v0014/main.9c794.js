...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/src/project.7148a.js';
        if (jsList) {
            jsList = jsList.map(function (x) {
                return 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/src/' + x;
            });
    ...
    cc.AssetLibrary.init({
        libraryPath: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/res/import',
        rawAssetsBase: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/res/raw-',
...
// main.9c794.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
    ...
    if (isRuntime) {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/src/settings.a5468.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/src/cocos2d-runtime.js');
        require('jsb-adapter/engine/index.js');
    }
    else {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/src/settings.a5468.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/src/cocos2d-jsb.js');
...
if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/cocos2d-js.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v0014/cocos2d-js-min.3a02f.js';
