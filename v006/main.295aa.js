...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/src/project.53f70.js';
        if (jsList) {
            jsList = jsList.map(function (x) {
                return 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/src/' + x;
            });
    ...
    cc.AssetLibrary.init({
        libraryPath: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/res/import',
        rawAssetsBase: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/res/raw-',
...
// main.295aa.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
    ...
    if (isRuntime) {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/src/settings.374ec.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/src/cocos2d-runtime.js');
        require('jsb-adapter/engine/index.js');
    }
    else {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/src/settings.374ec.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/src/cocos2d-jsb.js');
...
if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/cocos2d-js.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v006/cocos2d-js-min.3a02f.js';
