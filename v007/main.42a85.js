...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/src/project.dev.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/src/project.bbda6.js';
        if (jsList) {
            jsList = jsList.map(function (x) {
                return 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/src/' + x;
            });
    ...
    cc.AssetLibrary.init({
        libraryPath: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/res/import',
        rawAssetsBase: 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/res/raw-',
...
// main.42a85.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
    ...
    if (isRuntime) {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/src/settings.95f5a.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/src/cocos2d-runtime.js');
        require('jsb-adapter/engine/index.js');
    }
    else {
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/src/settings.95f5a.js');
        require('https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/src/cocos2d-jsb.js');
...
if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/cocos2d-js.js' : 'https://cdn.jsdelivr.net/gh/choitaixiu/xx@master/v007/cocos2d-js-min.3a02f.js';
